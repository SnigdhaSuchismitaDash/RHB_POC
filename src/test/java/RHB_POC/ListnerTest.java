...
public class ListnerTest extends ScenarioTest1 implements IResultListener {

	ExtentTest testReporter;
	ExtentReports reporter = new ExtentReports("build/"+getClass()+"Report.html", true, DisplayOrder.NEWEST_FIRST, NetworkMode.ONLINE,
			Locale.ENGLISH);
	@Override
