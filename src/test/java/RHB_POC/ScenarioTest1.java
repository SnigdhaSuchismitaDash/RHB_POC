...
public class ScenarioTest1 {
	...
	public void launchChrome() throws MalformedURLException
	{
		...
		DesiredCapabilities capabilities = new DesiredCapabilities();
 		...
 		//capabilities.setCapability("chromedriverExecutable", "D://Setup_Files//ChromeDriver//chromedriver.exe");
 		
 		capabilities.setCapability("chromedriverExecutable", "D://Aditya//chromedriver.exe");
 		...
 		public void homeLoanCalculator() throws InterruptedException
 		{
			...
			Thread.sleep(2000);
			driver.findElementByXPath("//a[@id='rhbheaderplaceholder_0_menuListView_menuListView2_2_menuListView3_0_menuLink3_3']").click();
			System.out.println("Click on Loans");
			Thread.sleep(2000);
			driver.findElementByXPath("//a[@id='rhbheaderplaceholder_0_menuListView_menuListView2_2_menuListView3_0_menuListView4_3_menuLink4_0']").click();
			...
			System.out.println("Click on Home Loans");
			Thread.sleep(3000);
			driver.findElementByXPath("//a[@id='rhbcontentplaceholder_0_productComponent_RHBEasy_productMenuList_0_productMenuLink_0']").click();
			System.out.println("Click on My Full Flexi Home Loan");
			Thread.sleep(7000);
			JavascriptExecutor jse=(JavascriptExecutor) driver;
	 		WebElement scroll=driver.findElement(By.xpath("//a[@id='rhbcontentplaceholder_0_rhbdetailothersection_3_calculatorListView_modalPopupLink_0']"));
 		...
 		public void homeAffordabilityCalculator() throws InterruptedException
 		{
			...
			JavascriptExecutor jse0=(JavascriptExecutor) driver;
	 		WebElement scroll0=driver.findElement(By.xpath("//a[@id='rhbcontentplaceholder_0_rhbdetailothersection_3_calculatorListView_modalPopupLink_1']"));
	 		driver.manage().timeouts().implicitlyWait(120, TimeUnit.SECONDS);
 		  ...
 		  public void investment() throws InterruptedException
 		{
			...
			driver.findElementByXPath("//a[@id='rhbheaderplaceholder_0_menuListView_menuListView2_2_menuLink2_0']").click();
			 System.out.println("Click on Personal");
			Thread.sleep(2000);
			driver.findElementByXPath("//a[@id='rhbheaderplaceholder_0_menuListView_menuListView2_2_menuListView3_0_menuLink3_14']").click();
			 System.out.println("Click on Investment");
			Thread.sleep(2000);
			driver.findElementByXPath("//a[@id='rhbheaderplaceholder_0_menuListView_menuListView2_2_menuListView3_0_menuListView4_14_menuLink4_0']").click();
